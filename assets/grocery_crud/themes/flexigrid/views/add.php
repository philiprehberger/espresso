<?php
	...
	$this->set_js_config($this->default_theme_path.'/flexigrid/js/flexigrid-add_1.js?'.time());
...
<script>
	var validation_url = '<?php  echo str_replace ('m_lessonplans/index.php/','',$validation_url); ?>';
	var list_url = '<?php  echo str_replace ('m_lessonplans/index.php/','',$list_url); ?>';
