...
class UploadHandler {
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        ...
        $this->options = array(
            ...
            'upload_dir' => '/var/www/html/m_lessonplans/assets/uploads/files/',
            'upload_url' => '/lessonplans/assets/uploads/files/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
    ...
    protected function get_upload_path($file_name = null, $version = null) {
        ...
        //echo $file_name; exit();
        //TODO: replace spaces and ponctuation and timestamp end
